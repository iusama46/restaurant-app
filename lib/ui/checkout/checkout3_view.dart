...
class _Checkout3ViewState extends State<Checkout3View> {
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          if (isPriority)
                            memoController.text = 'Click & Collect';
                          else
                            memoController.text = '';

                          setState(() {});
                        },
                        child: checkIsPrioritySelected('Click & Collect'),
                      ),
                    ),
                    const SizedBox(
  ...
  Widget checkIsPrioritySelected(String title) {
    if (!isPriority) {
      return changePrToWhite(title);
    } else {
      return changePrToOrange(title);
    }
  }
  ...
  Widget changePrToWhite(String title) {
    return Container(
        width: PsDimens.space140,
        child: Container(
          decoration: BoxDecoration(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                  width: 50, height: 50, child: const Icon(Icons.breakfast_dining)),
              Container(
                margin: const EdgeInsets.only(
                  left: PsDimens.space16,
                  right: PsDimens.space16,
  ...
  Widget changePrToOrange(String title) {
    return Container(
      width: PsDimens.space140,
      child: Container(
        decoration: BoxDecoration(
