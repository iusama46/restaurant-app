...
class PsColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFF143F1E);
  ...
  static const Color golden_color = Color(0xFFAB8B5A);
  ...
  // static const Color _l_base_dark_color = Colors.yellow;
  //static const Color _l_base_dark_color = Color(0xFFAB8B5A);
  static const Color _l_base_dark_color = Color(0xFFC5A169);
  static const Color _l_base_light_color = Color(0xFFEFEFEF);

  static const Color _l_text_primary_color = Color(0xFF143F1E);
  static const Color _l_text_primary_light_color = Color(0xFF143F1E);
  static const Color _l_text_primary_dark_color = Color(0xFF25425D);

  //static const Color _l_icon_color = Color(0xFF445E76);
  static const Color _l_icon_color = Color(0xFF143F1E);
